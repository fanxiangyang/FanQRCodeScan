...
#import "FanHistoryViewController.h"
#import "FanQRCell.h"
#import "FanDBManager.h"
#import "FanQRCodeModel.h"
#import "FanQRPreePopViewController.h"
#import "FanCommonHead.h"
@interface FanHistoryViewController ()<UIViewControllerPreviewingDelegate,FanQRPreePopViewControllerDelegate>
@property(nonatomic,strong)NSMutableArray *dataArray;

@end

@implementation FanHistoryViewController
...
-(NSArray *)myQRCodeList{
    ...
    FMResultSet *set=[[FanDBManager shareManager]fan_selectAllFromTableWithSql:@"select * from FanQRCodeModel where insertType = 0  order by uploadTime desc;"];
    while ([set next]) {
